...
FatFs's licence is a one-clause BSD-style licence: redistributions of source
must keep its copyright notice, condition and disclaimer, which `ffconf.h`
does. Binary redistribution carries no condition.
